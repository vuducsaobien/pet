...
@php
    ...
    $elements = [[
            ...
            'label'     => Form::label('article_per_page', 'Per Page', $formLabelAttributes),
            'element'   => Form::number('article_per_page', $item['article_per_page'] ?? '', $formInputAttributes)
        ],[
            'label'     => Form::label('ordering', 'Ordering', $formLabelAttributes),
            'element'   => Form::number('ordering', $item['ordering'] ?? '', $formInputAttributes)
        ],[
